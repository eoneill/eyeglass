  ...
  return function(uri, prev, done) {
    ...
    function importAssetsFor(mod) {
      importUtils.importOnce({
        ...
        file: "autoGenerated:" + uriUtils.join(mod.name, "assets")
      }, done);
    }

    var isRelativeImport = uriUtils.isRelative(uri);
    ...
    if (!assetsImport || moduleName === "eyeglass") {
